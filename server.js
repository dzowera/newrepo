...
const utilities = require("./utilities/") // utilities in scope
...
// Index route (MVC style) wrapped in error handler
app.get("/", utilities.handleErrors(baseController.buildHome))

// Inventory routes (controllers inside inventoryRoute must also use handleErrors)
